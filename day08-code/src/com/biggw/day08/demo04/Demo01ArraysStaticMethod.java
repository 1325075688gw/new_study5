...
/*
 * 数组排序用Arrays.sort(int[] arr, Comparator comparator)
 * 集合排序用Collections.sort(int[] arr, Comparator comparator)
 * 集合排序用Collections.sort(int[] arr)   // 集合implements  Comparable接口,实现里面的compareTo方法
 *
 *  Arrays里面常用的静态方法:
